            ...
            <main className={classes.main}>
              <Paper className={classes.paper}>
                ...
                <form className={classes.form} onSubmit={this.handleSubmit}>
                  ...
                  <FormControl margin="normal" required fullWidth>
                    <InputLabel htmlFor="subject">Phone Number</InputLabel>
                    <Input id="subject" name="subject" autoComplete="subject" disableUnderline/>
                  </FormControl>
                  <FormControl margin="normal" required fullWidth>
                    <InputLabel htmlFor="message">Message</InputLabel>
                    <Input id="message" name="message" autoComplete="message" multiline placeholder="Ex. 7g of Black Tuna, Oz of Purple Kush"/>
                  </FormControl>
